...
pub mod pallet {
    ...
    use frame_support::{sp_runtime::traits::AtLeast32BitUnsigned, traits::EnsureOriginWithArg};
    ...
    pub trait Config: frame_system::Config {
        ...
        /// Balance type
        type Balance: Parameter + Member + MaybeSerializeDeserialize + AtLeast32BitUnsigned + Default + Copy;
...
impl<T: pallet::Config> Registry<T::AssetId, Vec<u8>, T::Balance, DispatchError> for Pallet<T> {
...
impl<T: pallet::Config> ShareTokenRegistry<T::AssetId, Vec<u8>, T::Balance, DispatchError> for Pallet<T> {
...
impl<T: pallet::Config> GetByKey<T::AssetId, T::Balance> for Pallet<T> {
